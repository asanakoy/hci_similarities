...
if nargin == 1 
    ...
    features_path = sprintf('~/workspace/OlympicSports/exemplar_cnn/features/fc4/features_%s_ecnn_fc4_36patches_quadrantpool_zscores.mat', ...
                             category_name);
    output_path = sprintf('~/workspace/OlympicSports/exemplar_cnn/similarities/fc4/sim_%s_ecnn_fc4_36patches_quadrantpool_zscores.mat', category_name);
end
