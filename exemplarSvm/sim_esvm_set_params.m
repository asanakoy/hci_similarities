...
if ~exist('esvm_train_params', 'var') ...
   || ~isfield(esvm_train_params, 'is_inited') || esvm_train_params.is_inited ~= 1
    ...
    esvm_train_params.negatives_train_data_fraction = 1.0; % Portion of data to use for training.
    esvm_train_params.use_negative_mining = 0; % Train at once or use mining?
...
ESVM_MODELS_DIR = '~/workspace/OlympicSports/esvm/alexnet_zscores_esvm_at_once_models_long_jump_negative_cliques/'; % Output dir.
